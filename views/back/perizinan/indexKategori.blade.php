...
@section('title', 'Data - Kategori Perizinan')
@section('main')
<div class="pagetitle">
	<h1>Data Kategori Perizinan</h1>
	<nav>
	  <ol class="breadcrumb">
	  	...
	  	<table class="table table-bordered datatable">
				...
				<tbody>
				  ...
				  <tr>
						...
						<td>{{$d->keterangan}}</td>
						<td>
							<a href="{{url('perizinan-kategori-delete', $d->id)}}" onclick="return confirm('Hapus data ini?')"><button class="btn btn-info"><i class="bi bi-trash-fill"></i></button></a>
						</td>
				  </tr>
				  @endforeach
				</tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      	<h5 class="modal-title">Tambah Data Kategori Perizinan</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      	<form class="row g-3" action="{{url('perizinan-kategori-proses')}}" method="POST" enctype="multipart/form-data">
    			@csrf
	        <div class="col-12">
