...
@section('title', 'Data - Kategori Exportir')
@section('main')
<div class="pagetitle">
	<h1>Data Kategori Exportir</h1>
	<nav>
	  <ol class="breadcrumb">
	    <li class="breadcrumb-item"><a href="{{url('/')}}">Dashboard</a></li>
	    <li class="breadcrumb-item active">Kategori Exportir</li>
	  </ol>
	</nav>
</div>
	  	...
	  	<table class="table table-bordered datatable">
				...
				<tbody>
				  ...
				  <tr>
						...
						<td>{{$d->keterangan}}</td>
						<td>
							<a href="{{url('exportir-kategori-delete', $d->id)}}" onclick="return confirm('Hapus data ini?')"><button class="btn btn-info"><i class="bi bi-trash-fill"></i></button></a>
						</td>
				  </tr>
				  @endforeach
				</tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form class="row g-3" action="{{url('exportir-kategori-proses')}}" method="POST" enctype="multipart/form-data">
    			@csrf
	        <div class="col-12">
