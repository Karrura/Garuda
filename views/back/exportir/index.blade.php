...
<div class="card">
	<div class="card-header">
		<a href="{{url('exportir-artikel-create')}}"><button type="button" class="btn btn-info rounded-pill" data-bs-toggle="modal" data-bs-target="#basicModal"><i class="bi bi-plus-lg mr"></i>Artikel</button></a>
				...
				<tbody>
				  ...
				  <tr>
						...
						<td>
							...
							<a href="{{url('exportir-artikel-delete', $d->id)}}" onclick="return confirm('Hapus data ini?')"><button class="btn btn-info"><i class="bi bi-trash-fill"></i></button></a>
						</td>
				  </tr>
					  ...
					  <div class="modal-dialog modal-lg">
					    <div class="modal-content">
					      ...
					      <div class="modal-body">
					      	<div class="card-body">
					      		<div class="text-center"><img src="{{ asset('backend/exportir/'.$d->gambar) }}" alt="no pict identified"  class="img-fluid"></div>
